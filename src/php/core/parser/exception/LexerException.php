...
/**
* A class that represents an exception thrown by the lexer when parsing a source code.
*
...
{
    /**
    * Constructs a new LexerException object with a given message, code, and previous exception.
    *
